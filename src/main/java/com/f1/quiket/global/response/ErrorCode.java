...
public enum ErrorCode {
    ...
    AUTH_OAUTH_TEMP_TOKEN_STORE_FAILED(503, "AUTH_OAUTH_TEMP_TOKEN_STORE_FAILED", "OAuth 임시 토큰 처리에 실패했습니다."),
    AUTH_OAUTH_USER_INFO_FAILED(503, "AUTH_OAUTH_USER_INFO_FAILED", "Kakao 사용자 정보 조회에 실패했습니다."),
    AUTH_APPLE_INVALID_TOKEN(401, "AUTH_APPLE_INVALID_TOKEN", "Apple Identity Token이 올바르지 않습니다."),
    AUTH_APPLE_SIGNUP_TOKEN_INVALID(401, "AUTH_APPLE_SIGNUP_TOKEN_INVALID", "Apple 회원가입 토큰이 올바르지 않거나 만료되었습니다."),
    AUTH_APPLE_LINK_TOKEN_INVALID(401, "AUTH_APPLE_LINK_TOKEN_INVALID", "Apple 계정 연동 토큰이 올바르지 않거나 만료되었습니다."),
    AUTH_APPLE_ACCOUNT_ALREADY_LINKED(409, "AUTH_APPLE_ACCOUNT_ALREADY_LINKED", "이미 Apple 계정이 연동된 사용자입니다."),
    AUTH_APPLE_PROVIDER_ALREADY_LINKED(409, "AUTH_APPLE_PROVIDER_ALREADY_LINKED", "이미 다른 사용자에게 연동된 Apple 계정입니다."),
    AUTH_APPLE_CONFIG_ERROR(503, "AUTH_APPLE_CONFIG_ERROR", "Apple 로그인 설정이 올바르지 않습니다."),
    AUTH_APPLE_KEY_FETCH_FAILED(503, "AUTH_APPLE_KEY_FETCH_FAILED", "Apple 공개키 조회에 실패했습니다."),
